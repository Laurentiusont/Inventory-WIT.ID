<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-3 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/img/WIT-logo.png') }}" class="navbar-brand-img" alt="...">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('inventory') ? 'active' : '' }}" href="{{ url('inventory') }}">
                        ...
                        <p class="m-1 textSidebar">Inventory</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('kantor') ? 'active' : '' }}" href="{{ url('kantor') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/img/icon-office.png') }}" width="14px" height="14px"
                                viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>shop </title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <p class="m-1 textSidebar">Office</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('perbaikan') ? 'active' : '' }}"
                        href="{{ url('perbaikan') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            function confirmLogout() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Lakukan pengalihan ke halaman logout
                        window.location.href = "{{ url('logout') }}";
                    }
                });
            }
        </script>
        {{-- </asid <li class="nav-item">
        <a class="nav-link" href="javascript:void(0);" onclick="confirmLogout()">
            <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <img src="{{ asset('assets/img/icon-logout.png') }}" width="12px" height="12px"
